...
if __name__ == "__main__":
    ...
    plot_messages_pie_chart(parsed_data, "messages_by_person.png")
    plot_messages_per_hour(parsed_data, "messages_per_hour.png")
    plot_messages_calendar_heatmap(parsed_data, "messages_calendar_heatmap.png")
    plot_messages_per_weekday(parsed_data, "messages_per_weekday.png")
