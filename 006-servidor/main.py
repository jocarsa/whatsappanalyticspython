...
def upload_file():
    if request.method == 'POST':
        ...
        if file:
            ...
            # Generate all charts
            plot_messages_pie_chart(parsed_data, os.path.join(OUTPUT_FOLDER, "messages_by_person.png"))
            plot_messages_per_hour(parsed_data, os.path.join(OUTPUT_FOLDER, "messages_per_hour.png"))
            plot_messages_calendar_heatmap(parsed_data, os.path.join(OUTPUT_FOLDER, "messages_calendar_heatmap.png"))
            plot_messages_per_weekday(parsed_data, os.path.join(OUTPUT_FOLDER, "messages_per_weekday.png"))
...
def display_charts():
    images = [
        "messages_by_person.png",
        "messages_per_hour.png",
        "messages_calendar_heatmap.png",
        "messages_per_weekday.png"
    ]
